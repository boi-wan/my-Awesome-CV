...
| Command                 | Description                                                                                                                                               |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `make` or `make cv.pdf` | Compiles `cv.tex` via `texlive/texlive:latest` (if Docker is available). Source Sans 3 and Roboto fonts are installed inside the container automatically. |
...
| ---------- | ------------- | ---------------- |
| `CV_EMAIL` | Email address | `me@example.com` |
